...
class HomeActivity : AppCompatActivity() {
    ...
    private fun initializeViews() {
        ...
        // Standardize My Activity Cards content
        ...
        complaintsCard.findViewById<ImageView>(R.id.ivActionIcon).setImageResource(R.drawable.myreports_img)
        ...
        fStore.collection("users").document(userId).get()
            .addOnSuccessListener { doc ->
                if (doc != null && doc.exists()) {
                    val name = doc.getString("name") ?: doc.getString("Name") ?: "User"
